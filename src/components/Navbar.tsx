					...
					{mobileOpen && (
						...
						>
							<div className="px-6 py-4 space-y-4">
								...
								<div className="rounded-lg border border-black/10 bg-white px-4 py-3 text-sm text-black space-y-2">
									<Link href="/blog" className="flex items-center gap-2 hover:text-black/60 transition">
										<BookOpen className="h-4 w-4" />
										<span>Blog</span>
									</Link>
									<Link href="/about" className="flex items-center gap-2 hover:text-black/60 transition">
										<Building2 className="h-4 w-4" />
										<span>About</span>
									</Link>
									<Link href="/contact" className="flex items-center gap-2 hover:text-black/60 transition">
