    ...
    <PageTransition>
      ...
      <section className="relative overflow-hidden">
        <div className="mx-auto max-w-7xl px-6 pt-14 pb-10">
          <div className="grid items-center gap-10 md:grid-cols-2">
            ...
            <motion.div {...fadeUp} transition={{ ...fadeUp.transition, delay: 0.1 }} viewport={{ once: true }}>
        ...
        <div className="mx-auto max-w-7xl px-6 py-10">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {["Bridging the gap between law and technology","Empowering advocates, students, and citizens","Redefining how India learns, practices, and accesses law"].map((title, idx) => (
              <motion.div key={title} {...fadeUp} transition={{ ...fadeUp.transition, delay: 0.05 * idx }} viewport={{ once: true }} className="premium-card text-black hover-lift">
      ...
      <section className="relative overflow-hidden">
        <div className="mx-auto max-w-7xl px-6 py-10">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <motion.div {...fadeUp} viewport={{ once: true }} className="hover-lift">
            ...
            <motion.div {...fadeUp} transition={{ ...fadeUp.transition, delay: 0.05 }} viewport={{ once: true }} className="hover-lift">
            ...
            <motion.div {...fadeUp} transition={{ ...fadeUp.transition, delay: 0.1 }} viewport={{ once: true }} className="hover-lift">
        ...
        <div className="mx-auto max-w-7xl px-6 pb-12">
          <div className="grid gap-4 md:grid-cols-3">
            {["3 Core Platforms","25+ Legal Draft Templates","AI trained on 10,000+ Case Laws"].map((t, i) => (
              <motion.div key={t} {...fadeUp} transition={{ ...fadeUp.transition, delay: 0.05 * i }} viewport={{ once: true }} className="rounded-xl border border-black/10 bg-white p-5 text-center hover-lift">
