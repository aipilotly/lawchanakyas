			...
			<div className="mx-auto max-w-7xl px-6 py-16">
				...
				<section className="mb-16">
					...
					<div className="flex flex-wrap gap-4">
						<Link href="/advocates/courtroom-simulation/demo" className="btn-primary">
							<Play className="h-4 w-4" /> Try a Free Demo
						</Link>
						<Link href="/advocates/courtroom-simulation/video" className="inline-flex items-center gap-2 px-5 py-2 rounded-full border border-black/10 bg-white text-black hover:bg-black/5 transition">
							Watch 90-sec Demo
						</Link>
					</div>
				</section>
